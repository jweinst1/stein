...
module.exports={
    "begin":{
        ...
        "vocab":{
            ...
            "adj":["calm", "chaotic", "angry", "immense", "blissful", "strong", "sharp", "shimmering", "dangerous", "glowing", "breezy"]
        }
    },
    "des_obj":{
        "grammar":{
    ...
    "act":{
        ...
        "vocab":{
            ...
            "post_q":["for"],
            "det":["a"],
            "act_obj":["kiss", "hand", "rose", "blessing", "hug", "flower", "glance"]
        }
    }
}
